...
import { Briefcase, GraduationCap, MapPin, Heart, Phone, Info, Globe, Plus, Save, X, Trash2, Home, Mail, Link as LinkIcon, Calendar, User as UserIcon, Languages, Mic, Quote, Droplet, PenLine, Star, Pen } from 'lucide-react';
import { User } from '../../types';
import { useLanguage } from '../../context/LanguageContext';
import { SectionType, PrivacyLevel, PlaceType, Work, University, School, Place, SocialLink, Website, FamilyMember, Relationship, OtherName, LifeEvent } from './types';
import { COUNTRIES_DATA, SOCIAL_PLATFORMS, LANGUAGES_LIST, MONTHS, RELATIONSHIP_STATUS_OPTIONS, PARTNER_REQUIRED_STATUSES, FAMILY_RELATIONS_OPTIONS, OTHER_NAME_TYPES, MOCK_FRIENDS_LIST, JOB_TITLES, DEGREES, DAYS, YEARS } from './constants';
import PrivacySelect from './PrivacySelect';
import { PrivacyIcon, getPlatformIcon } from './utils';
